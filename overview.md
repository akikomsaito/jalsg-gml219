...
8月3日、研究代表医師より観察期間中央値の記載相談を受け、逆Kaplan-Meier法（Reverse KM, Schemper & Smith 1996）の採用を実データ（2025年12月時点データ、FAS 121例）で検証（中央値3.64年/約43.7か月、範囲0.02〜5.49年）した上で、正式なSASプログラム[`program/JALSG-GML219_Inquiry05_FollowUp.sas`](program/JALSG-GML219_Inquiry05_FollowUp.sas)として追加した（未実行、SAS環境での実行待ち）。詳細は[`docs/work-logs/20260803-work-log.md`](docs/work-logs/20260803-work-log.md)を参照。
